...
<div id="contents-title">
  ...
  <div id="contents-entries">
    ...
    <div>
      <details>
        ...
        <ul>
          ...
          <li><a href="#bicycle-sized">Bicycle-sized vehicles</a></li>
          <li><a href="#cars">Cars</a></li>
          <li><a href="#small_cars">Small cars</a></li>
    ...
    <div>
      <details>
        <summary><a href="#roads">Road use</a></summary>
        <ul>
          <li><a href="#pricing">Congestion pricing</a></li>
...
### <a name="bicycle-sized"></a>Bicycle-sized vehicles
